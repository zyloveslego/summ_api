...
from app.utils.sen_tovec_service import SenToVecService
...
class AffinityPropagationClustering:
    ...
    def clustering(self, sentences, n_clusters, metric="WMD", distance_to_sim=guassian_kernel_transfer):
        """
        ...
        sc = AffinityPropagation(affinity='precomputed').fit_predict(X=sim_matrix)
