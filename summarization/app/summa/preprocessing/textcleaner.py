...
from summarization.app.summa.syntactic_unit import SyntacticUnit
...
def clean_text_by_sentences_self_define(text, language="english"):
    def _trim(text):
        text = text.replace('\n', '')
        text = text.strip()
        return text
    ...
    if isinstance(text, list):
        ...
        original_sentences = _split_sentence(text)
